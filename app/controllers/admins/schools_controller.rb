class Admins::SchoolsController < ApplicationController
	...
	def params_school
		params.require(:school).permit(:name , :location , :description , :contact_personal , :contact_number , :email , :latitude , :longitude , :logo , :country , :state , :status , :contact_id,:institution_id)	
	end
end
